...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [415],
    {
        ...
        7508: function (t, e, i) {
            ...
            let n = (0, i(7653).createContext)({ transformPagePoint: (t) => t, isStatic: !1, reducedMotion: "never" });
        },
        7801: function (t, e, i) {
            i.d(e, {
                O: function () {
            ...
            let n = (0, i(7653).createContext)(null);
        },
        5126: function (t, e, i) {
            i.d(e, {
                Pn: function () {
        ...
        4415: function (t, e, i) {
            ...
            let g = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"],
                y = ["initial", ...g];
            function x(t) {
                return v(t.animate) || y.some((e) => f(t[e]));
            }
            function P(t) {
            ...
            let w = {
                ...
                A = {};
            for (let t in w) A[t] = { isEnabled: (e) => w[t].some((t) => !!e[t]) };
            var T = i(9701),
                S = i(3930);
            ...
            let j = (t) => !!(t && t.getVelocity),
                F = { x: "translateX", y: "translateY", z: "translateZ", transformPerspective: "perspective" },
                B = k.length;
            var O = i(1888);
            let W = (t, e) => (e && "number" == typeof t ? e.transform(t) : t);
            var $ = i(7219),
                U = i(6183);
            let I = { ...$.Rx, transform: Math.round },
                N = {
                    borderWidth: U.px,
                    borderTopWidth: U.px,
            ...
            let z = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} });
            function Z(t, e, i) {
            ...
            let K = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
                _ = { offset: "strokeDashoffset", array: "strokeDasharray" };
            function J(t, { attrX: e, attrY: i, attrScale: n, originX: r, originY: s, pathLength: o, pathSpacing: a = 1, pathOffset: l = 0, ...u }, h, c, d) {
                if ((H(t, u, h, d), c)) {
            ...
            function tn(t, e, i, n) {
                for (let i in (te(t, e, void 0, n), e.attrs)) t.setAttribute(ti.has(i) ? i : d(i), e.attrs[i]);
            }
            function tr(t, e) {
                let { style: i } = t,
                    n = {};
                    ...
                    useVisualState: td({
                        ...
                        onMount: (t, e, { renderState: i, latestValues: n }) => {
                            tp.Wi.read(() => {
                                ...
                                tp.Wi.render(() => {
                                    J(i, n, { enableHardwareAcceleration: !1 }, tt(e.tagName), t.transformTemplate), tn(e, i);
                                });
                        },
                    }),
                },
                tf = { useVisualState: td({ scrapeMotionValuesFromProps: tr, createRenderState: z }) };
            function tv(t, e, i, n = { passive: !0 }) {
                return t.addEventListener(e, i, n), () => t.removeEventListener(e, i);
            }
            let tg = (t) => ("mouse" === t.pointerType ? "number" != typeof t.button || t.button <= 0 : !1 !== t.isPrimary);
            function ty(t, e = "page") {
                return { point: { x: t[e + "X"], y: t[e + "Y"] } };
            }
            let tx = (t) => (e) => tg(e) && t(e, ty(e));
            function tP(t, e, i, n) {
                return tv(t, e, tx(i), n);
            }
            var tb = i(9432);
            function tw(t) {
                let e = null;
            ...
            function tE(t, e) {
                ...
                return tP(
                    ...
                    (n, r) => {
                        if ("touch" === n.pointerType || tV()) return;
                        let s = t.getProps();
                        t.animationState && s.whileHover && t.animationState.setActive("whileHover", e), s[i] && tp.Wi.update(() => s[i](n, r));
                    },
            ...
            class tD extends tC {
                mount() {
                    this.unmount = (0, tb.z)(tE(this.node, !0), tE(this.node, !1));
                }
                unmount() {}
            }
            class tM extends tC {
                ...
                mount() {
                    this.unmount = (0, tb.z)(
                        tv(this.node.current, "focus", () => this.onFocus()),
                        tv(this.node.current, "blur", () => this.onBlur())
                    );
                }
                unmount() {}
            }
            ...
            class tj extends tC {
                            ...
                            let i = this.node.getProps(),
                                n = tP(
                                    ...
                                    (t, e) => {
                                        ...
                                        tp.Wi.update(() => {
                                            r || tk(this.node.current, t.target) ? i && i(t, e) : n && n(t, e);
                                        });
                                    },
                                    { passive: !(i.onTap || i.onPointerUp) }
                                ),
                                r = tP(window, "pointercancel", (t, e) => this.cancelPress(t, e), { passive: !(i.onTapCancel || i.onPointerCancel) });
                            (this.removeEndListeners = (0, tb.z)(n, r)), this.startPress(t, e);
                        }),
                        (this.startAccessiblePress = () => {
                            let t = tv(this.node.current, "keydown", (t) => {
                                    "Enter" !== t.key ||
                                        this.isPressing ||
                                        (this.removeEndListeners(),
                                        (this.removeEndListeners = tv(this.node.current, "keyup", (t) => {
                                            "Enter" === t.key &&
                                                this.checkPressEnd() &&
                                                tL("up", (t, e) => {
                ...
                startPress(t, e) {
                    ...
                    n && this.node.animationState && this.node.animationState.setActive("whileTap", !0), i && tp.Wi.update(() => i(t, e));
                }
                checkPressEnd() {
                ...
                mount() {
                    let t = this.node.getProps(),
                        e = tP(t.globalTapTarget ? window : this.node.current, "pointerdown", this.startPointerPress, { passive: !(t.onTapStart || t.onPointerStart) }),
                        i = tv(this.node.current, "focus", this.startAccessiblePress);
            ...
            class tU extends tC {
                ...
                startObserver() {
                    ...
                    let { viewport: t = {} } = this.node.getProps(),
                        ...
                        s = { root: e ? e.current : void 0, rootMargin: i, threshold: "number" == typeof n ? n : t$[n] };
                    return (function (t, e, i) {
                        let n = (function ({ root: t, ...e }) {
                            ...
                            let n = tB.get(i),
                                r = JSON.stringify(e);
                            return n[r] || (n[r] = new IntersectionObserver(tW, { root: t, ...e })), n[r];
                        })(e);
                        return (
                            tF.set(t, i),
                            n.observe(t),
            ...
            let tz = (t) => 1e3 * t,
                ...
                tK = (t, e, i) => (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
            function t_(t, e, i, n) {
                ...
                let r = (e) =>
                    (function (t, e, i, n, r) {
                        let s, o;
                        let a = 0;
                        do (s = tK((o = e + (i - e) / 2), n, r) - t) > 0 ? (i = o) : (e = o);
            ...
            let tJ = t_(0.42, 0, 1, 1),
                ...
                et = {
                    ...
                    backInOut: t7,
                    backOut: t9,
                    anticipate: (t) => ((t *= 2) < 1 ? 0.5 * t4(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
                },
                ee = (t) => {
                    if (Array.isArray(t)) {
                        (0, tH.k)(4 === t.length, "Cubic bezier arrays must contain four numerical values.");
                        let [e, i, n, r] = t;
                        return t_(e, i, n, r);
                    }
                    return "string" == typeof t ? ((0, tH.k)(void 0 !== et[t], `Invalid easing type '${t}'`), et[t]) : t;
                };
            var ei = i(6292),
                en = i(1999);
            function er({ duration: t = 300, keyframes: e, times: i, ease: n = "easeInOut" }) {
                let r = t1(n) ? n.map(ee) : ee(n),
                    s = { done: !1, value: e[0] },
                    o = (i && i.length === e.length ? i : (0, en.Y)(e)).map((e) => e * t),
                    a = (0, ei.s)(o, e, { ease: Array.isArray(r) ? r : e.map(() => r || t0).splice(0, e.length - 1) });
            ...
            function ed({ keyframes: t, restDelta: e, restSpeed: i, ...n }) {
                    ...
                    { stiffness: l, damping: u, mass: h, duration: c, velocity: d, isResolvedFromDuration: p } = (function (t) {
                        ...
                        if (!ec(t, eh) && ec(t, eu)) {
                            let i = (function ({ duration: t = 800, bounce: e = 0.25, velocity: i = 0, mass: n = 1 }) {
                                let r, s;
                                (0, tH.K)(t <= tz(10), "Spring duration must be 10 seconds or less");
                                let o = 1 - e;
                                (o = (0, ea.u)(0.05, 1, o)),
                                        ...
                                        ? ((r = (e) => {
                                          ...
                                          (s = (e) => {
                                              let n = e * o * t,
                                                  ...
                                                  a = el(Math.pow(e, 2), o);
                                              return ((n * i + i - s) * Math.exp(-n) * (-r(e) + 0.001 > 0 ? -1 : 1)) / a;
                                          }))
                                        : ((r = (e) => -0.001 + Math.exp(-e * t) * ((e - i) * t + 1)), (s = (e) => t * t * (i - e) * Math.exp(-e * t)));
                                let a = (function (t, e, i) {
                                    let n = i;
                                    for (let i = 1; i < 12; i++) n -= t(n) / e(n);
                                    return n;
                                })(r, s, 5 / t);
                                if (((t = tz(t)), isNaN(a))) return { stiffness: 100, damping: 10, duration: t };
                                {
                ...
                if ((i || (i = y ? 0.01 : 2), e || (e = y ? 0.005 : 0.5), f < 1)) {
                    let t = el(g, f);
                    r = (e) => o - Math.exp(-f * g * e) * (((m + f * g * v) / t) * Math.sin(t * e) + v * Math.cos(t * e));
                } else if (1 === f) r = (t) => o - Math.exp(-g * t) * (v + (m + g * v) * t);
                else {
            ...
            function ep({ keyframes: t, velocity: e = 0, power: i = 0.8, timeConstant: n = 325, bounceDamping: r = 10, bounceStiffness: s = 500, modifyTarget: o, min: a, max: l, restDelta: u = 0.5, restSpeed: h }) {
                let c, d;
                let p = t[0],
                    m = { done: !1, value: p },
                ...
                let P = (t) => -g * Math.exp(-t / n),
                    ...
                    A = (t) => {
                        f(m.value) && ((c = t), (d = ed({ keyframes: [m.value, v(m.value)], velocity: eo(b, t, m.value), damping: r, stiffness: s, restDelta: u, restSpeed: h })));
                    };
                return (
                    A(0),
                    {
            ...
            let em = (t) => {
                ...
                return { start: () => tp.Wi.update(e, !0), stop: () => (0, tp.Pn)(e), now: () => (tp.frameData.isProcessing ? tp.frameData.timestamp : performance.now()) };
            };
            function ef(t) {
                let e = 0,
                    i = t.next(e);
            ...
            function eg({ autoplay: t = !0, delay: e = 0, driver: i = em, keyframes: n, type: r = "keyframes", repeat: s = 0, repeatDelay: o = 0, repeatType: a = "loop", onPlay: l, onStop: u, onComplete: h, onUpdate: c, ...d }) {
                let p,
                    m,
                    f,
                    v,
                ...
                P();
                let b = ev[r] || er;
                b !== er && "number" != typeof n[0] && ((v = (0, ei.s)([0, 100], n, { clamp: !1 })), (n = [0, 100]));
                let w = b({ ...d, keyframes: n });
                "mirror" === a && (g = b({ ...d, keyframes: [...n].reverse(), velocity: -(d.velocity || 0) }));
                let A = "idle",
                    T = null,
                    S = null,
                    V = null;
                ...
                let M = 0,
                    k = (t) => {
                        if (null === S) return;
                        y > 0 && (S = Math.min(S, t)), y < 0 && (S = Math.min(t - D / y, S));
                        let i = (M = null !== T ? T : Math.round(t - S) * y) - e * (y >= 0 ? 1 : -1),
                            r = y >= 0 ? i < 0 : i > D;
                        (M = Math.max(i, 0)), "finished" === A && null === T && (M = D);
                        let l = M,
                            u = w;
                        if (s) {
                            let t = Math.min(M, D) / E,
                                e = Math.floor(t),
                                i = t % 1;
                            !i && t >= 1 && (i = 1), 1 === i && e--, (e = Math.min(e, s + 1)) % 2 && ("reverse" === a ? ((i = 1 - i), o && (i -= o / E)) : "mirror" === a && (u = g)), (l = (0, ea.u)(0, 1, i) * E);
                        }
                ...
                let B = {
                    ...
                    set time(newTime) {
                        (M = newTime = tz(newTime)), null === T && f && 0 !== y ? (S = f.now() - newTime / y) : (T = newTime);
                    },
                    get duration() {
                        return tZ(null === w.calculatedDuration ? ef(w) : w.calculatedDuration);
                    },
                    get speed() {
                        return y;
                    },
            ...
            let ey = ((s = () => Object.hasOwnProperty.call(Element.prototype, "animate")), () => (void 0 === n && (n = s()), n)),
                ex = new Set(["opacity", "clipPath", "filter", "transform", "backgroundColor"]),
                eP = (t, e) =>
                    "spring" === e.type ||
                    "backgroundColor" === t ||
                    !(function t(e) {
                        return !!(!e || ("string" == typeof e && tG[e]) || tX(e) || (Array.isArray(e) && e.every(t)));
                    })(e.ease),
                eb = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
                ew = (t) => ({ type: "spring", stiffness: 550, damping: 0 === t ? 2 * Math.sqrt(550) : 30, restSpeed: 10 }),
                eA = { type: "keyframes", duration: 0.8 },
                eT = { type: "keyframes", ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
                eS = (t, { keyframes: e }) => (e.length > 2 ? eA : R.has(t) ? (t.startsWith("scale") ? ew(e[1]) : eb) : eT);
            var eV = i(6728);
            let eC = (t, e) => "zIndex" !== t && !!("number" == typeof e || Array.isArray(e) || ("string" == typeof e && (eV.P.test(e) || "0" === e) && !e.startsWith("url(")));
            var eE = i(8884);
            ...
            function eB(t, e) {
                let i = eF(t);
                return i !== eR && (i = eV.P), i.getAnimatableNone ? i.getAnimatableNone(e) : void 0;
            }
            let eO = (t) => /^0[^.\s]+$/.test(t);
            function eW(t, e) {
            ...
            let e$ = { skipAnimations: !1 },
                eU = (t, e, i, n = {}) => (r) => {
                    ...
                    let l = (function (t, e, i, n) {
                            ...
                            for (let t = 0; t < r.length; t++) {
                                ...
                                null === r[t] && (r[t] = 0 === t ? a : r[t - 1]),
                                    ("number" == typeof (u = r[t]) ? 0 === u : null !== u ? "none" === u || "0" === u || eO(u) : void 0) && l.push(t),
                                    "string" == typeof r[t] && "none" !== r[t] && "0" !== r[t] && (s = r[t]);
                            }
                            if (o && l.length && s) for (let t = 0; t < l.length; t++) r[l[t]] = eB(e, s);
                            return r;
                        })(e, t, i, s),
                        u = l[0],
                        h = l[l.length - 1],
                        c = eC(t, u),
                        d = eC(t, h);
                    (0, tH.K)(c === d, `You are trying to animate ${t} from "${u}" to "${h}". ${u} is not an animatable value - to enable this animation set ${u} to a value animatable to ${h} via the \`style\` property.`);
                    let p = {
                        keyframes: l,
                    ...
                    if (
                        ...
                        p.duration && (p.duration = tz(p.duration)),
                        p.repeatDelay && (p.repeatDelay = tz(p.repeatDelay)),
                        !c || !d || tY.current || !1 === s.type || e$.skipAnimations)
                    )
                        return (function ({ keyframes: t, delay: e, onUpdate: i, onComplete: n }) {
                            let r = () => (i && i(t[t.length - 1]), n && n(), { time: 0, speed: 1, duration: 0, play: tR.Z, pause: tR.Z, stop: tR.Z, then: (t) => (t(), Promise.resolve()), cancel: tR.Z, complete: tR.Z });
                            return e ? eg({ keyframes: [0, 1], duration: 0, delay: e, onComplete: r }) : r();
                    ...
                    if (!n.isHandoff && e.owner && e.owner.current instanceof HTMLElement && !e.owner.getProps().onUpdate) {
                        let i = (function (t, e, { onUpdate: i, onComplete: n, ...r }) {
                            let s, o;
                            if (!(ey() && ex.has(e) && !r.repeatDelay && "mirror" !== r.repeatType && 0 !== r.damping && "inertia" !== r.type)) return !1;
                            let a = !1,
                                l = !1,
                                u = () => {
                                    o = new Promise((t) => {
                            ...
                            let m = (function (t, e, i, { delay: n = 0, duration: r, repeat: s = 0, repeatType: o = "loop", ease: a, times: l } = {}) {
                                    ...
                                    l && (u.offset = l);
                                    let h = (function t(e) {
                                        if (e) return tX(e) ? tq(e) : Array.isArray(e) ? e.map(t) : tG[e];
                                    })(a);
                                    return (
                                        Array.isArray(h) && (u.easing = h),
                                        t.animate(u, { delay: n, duration: r, easing: Array.isArray(h) ? "linear" : h, fill: "both", iterations: s + 1, direction: "reverse" === o ? "alternate" : "normal" })
                                    );
                            ...
                            return (
                                ...
                                {
                                    then: (t, e) => o.then(t, e),
                                    attachTimeline: (t) => ((m.timeline = t), (m.onfinish = null), tR.Z),
                                    get time() {
                                        return tZ(m.currentTime || 0);
                                    },
                                    set time(newTime) {
                                        m.currentTime = tz(newTime);
                                    },
                                    get speed() {
            ...
            var eH = i(9086);
            let ez = (t) => (e) => e.test(t),
                eZ = [$.Rx, U.px, U.aQ, U.RW, U.vw, U.vh, { test: (t) => "auto" === t, parse: (t) => t }],
                eY = (t) => eZ.find(ez(t)),
                eX = [...eZ, eL.$, eV.P],
                eq = (t) => eX.find(ez(t));
            function eG(t, e, { delay: i = 0, transitionOverride: n, type: r } = {}) {
                ...
                for (let e in a) {
                    ...
                    if (
                        ...
                        continue;
                    let o = { delay: i, elapsed: 0, ...eW(s || {}, e) };
                    if (window.HandoffAppearAnimations) {
                        let i = t.getProps()[p];
                        if (i) {
                            let t = window.HandoffAppearAnimations(i, e, n, tp.Wi);
                    ...
                    n.start(eU(e, n, r, t.shouldReduceMotion && R.has(e) ? { type: !1 } : o));
                    let d = n.animation;
                    eI(l) && (l.add(e), d.then(() => l.remove(e))), u.push(d);
                }
                return (
                    o &&
                        Promise.all(u).then(() => {
                            o &&
                                (function (t, e) {
                                    ...
                                    for (let e in (s = { ...s, ...n })) {
                                        let i = th(s[e]);
                                        t.hasValue(e) ? t.getValue(e).set(i) : t.addValue(e, (0, eH.BX)(i));
                                    }
                                })(t, o);
                        }),
                    u
                                  ...
                                  return (function (t, e, i = 0, n = 0, r = 1, s) {
                                      ...
                                      return (
                                          Array.from(t.variantChildren)
                                              .sort(e_)
                                              .forEach((t, n) => {
                                                  t.notify("AnimationStart", e), o.push(eK(t, e, { ...s, delay: i + l(n) }).then(() => t.notify("AnimationComplete", e)));
                                              }),
                                          Promise.all(o)
                                      );
                                  })(t, e, s + n, o, a, i);
                                ...
                                let e = (e) =>
                                        Promise.all(
                                            e.map(({ animation: e, options: i }) =>
                                                (function (t, e, i = {}) {
                                                    let n;
                                                    if ((t.notify("AnimationStart", e), Array.isArray(e))) n = Promise.all(e.map((e) => eK(t, e, i)));
                                                    else if ("string" == typeof e) n = eK(t, e, i);
                                                    else {
                                                        let r = "function" == typeof e ? tN(t, e, i.custom) : e;
                                    ...
                                    i = { animate: e0(!0), whileInView: e0(), whileHover: e0(), whileTap: e0(), whileDrag: e0(), whileFocus: e0(), exit: e0() },
                                    n = !0,
                                    r = (e, i) => {
                                        let n = tN(t, i);
                                        if (n) {
                                ...
                                function s(s, o) {
                                    ...
                                    for (let e = 0; e < eQ; e++) {
                                        ...
                                        let m = eJ[e],
                                            ...
                                            x = f(y),
                                            P = m === o ? g.isActive : null;
                                        !1 === P && (d = e);
                                        let b = y === l[m] && y !== a[m] && x;
                                        if ((b && n && t.manuallyAnimateOnMount && (b = !1), (g.protectedKeys = { ...c }), (!g.isActive && null === P) || (!y && !g.prevProp) || v(y) || "boolean" == typeof y)) continue;
                                        let w = ((p = g.prevProp), ("string" == typeof y ? y !== p : !!Array.isArray(y) && !tI(y, p)) || (m === o && g.isActive && !b && x) || (e > d && x)),
                                            A = !1,
                                        ...
                                        let { prevResolvedValues: V = {} } = g,
                                            C = { ...V, ...S },
                                            E = (t) => {
                                                (w = !0), h.has(t) && ((A = !0), h.delete(t)), (g.needsAnimating[t] = !0);
                                            };
                                        for (let t in C) {
                                            let e = S[t],
                                                i = V[t];
                                            if (!c.hasOwnProperty(t)) (tl(e) && tl(i) ? tI(e, i) : e === i) ? (void 0 !== e && h.has(t) ? E(t) : (g.protectedKeys[t] = !0)) : void 0 !== e ? E(t) : h.add(t);
                                        }
                                        (g.prevProp = y),
                                            (g.prevResolvedValues = S),
                                            g.isActive && (c = { ...c, ...S }),
                                            n && t.blockInitialAnimation && (w = !1),
                                            w && (!b || A) && u.push(...T.map((t) => ({ animation: t, options: { type: m, ...s } })));
                                    }
                                    if (h.size) {
                                        let e = {};
                                        h.forEach((i) => {
            ...
            class e8 {
                constructor(t, e, { transformPagePoint: i, contextWindow: n, dragSnapToOrigin: r = !1 } = {}) {
                    if (
                        ...
                        (this.updatePoint = () => {
                            ...
                            let i = e4(this.lastMoveEventInfo, this.history),
                                ...
                                r = ((t = i.offset), (e = { x: 0, y: 0 }), Math.sqrt(e3(t.x, e.x) ** 2 + e3(t.y, e.y) ** 2) >= 3);
                            if (!n && !r) return;
                            let { point: s } = i,
                                { timestamp: o } = tp.frameData;
                        ...
                        (this.handlePointerMove = (t, e) => {
                            (this.lastMoveEvent = t), (this.lastMoveEventInfo = e6(e, this.transformPagePoint)), tp.Wi.update(this.updatePoint, !0);
                        }),
                        (this.handlePointerUp = (t, e) => {
                            ...
                            let s = e4("pointercancel" === t.type ? this.lastMoveEventInfo : e6(e, this.transformPagePoint), this.history);
                    ...
                    let s = e6(ty(t), this.transformPagePoint),
                        { point: o } = s,
                        { timestamp: a } = tp.frameData;
                    this.history = [{ ...o, timestamp: a }];
                    let { onSessionStart: l } = e;
                    l && l(t, e4(s, this.history)),
                ...
                return {
                    ...
                    velocity: (function (t, e) {
                        ...
                        let i = t.length - 1,
                            n = null,
                            r = e7(t);
                        for (; i >= 0 && ((n = t[i]), !(r.timestamp - n.timestamp > tz(0.1))); ) i--;
                        if (!n) return { x: 0, y: 0 };
            ...
            function iw({ scale: t, scaleX: e, scaleY: i }) {
                return !ib(t) || !ib(e) || !ib(i);
            }
            function iA(t) {
                return iw(t) || iT(t) || t.z || t.rotate || t.rotateX || t.rotateY;
            }
            function iT(t) {
                var e, i;
            ...
            function iC(t, { x: e, y: i }) {
                iV(t.x, e.translate, e.scale, e.originPoint), iV(t.y, i.translate, i.scale, i.originPoint);
            }
            function iE(t) {
            ...
            class iO {
                ...
                start(t, { snapToCursor: e = !1 } = {}) {
                    ...
                    this.panSession = new e8(
                        t,
                        {
                            onSessionStart: (t) => {
                                let { dragSnapToOrigin: i } = this.getProps();
                                i ? this.pauseAnimation() : this.stopAnimation(), e && this.snapToCursor(ty(t, "page").point);
                            },
                            onStart: (t, e) => {
                                let { drag: i, dragPropagation: n, onDragStart: r } = this.getProps();
                                if (i && !n && (this.openGlobalLock && this.openGlobalLock(), (this.openGlobalLock = tS(i)), !this.openGlobalLock)) return;
                                (this.isDragging = !0),
                                    (this.currentDirection = null),
                        ...
                        { transformPagePoint: this.visualElement.getTransformPagePoint(), dragSnapToOrigin: n, contextWindow: iF(this.visualElement) }
                    );
                }
                stop(t, e) {
                ...
                updateAxis(t, e, i) {
                    ...
                    this.constraints &&
                        ...
                        (s = (function (t, { min: e, max: i }, n) {
                            return void 0 !== e && t < e ? (t = n ? (0, ie.C)(e, t, n.min) : Math.max(t, e)) : void 0 !== i && t > i && (t = n ? (0, ie.C)(i, t, n.max) : Math.min(t, i)), t;
                ...
                resolveConstraints() {
                    ...
                    e && m(e)
                        ...
                        (this.elastic = (function (t = 0.35) {
                            return !1 === t ? (t = 0) : !0 === t && (t = 0.35), { x: id(t, "left", "right"), y: id(t, "top", "bottom") };
                        })(i)),
                        r !== this.constraints &&
                            n &&
                            this.constraints &&
                ...
                resolveRefConstraints() {
                    ...
                    if (!e || !m(e)) return !1;
                    let n = e.current;
                    (0, tH.k)(null !== n, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.");
                        ...
                        if (e) {
                            ...
                            n[t] = (function (t, e) {
                                let i = 0.5,
                                    n = ii(t),
                                    r = ii(e);
                                return r > n ? (i = (0, it.Y)(e.min, e.max - n, t.min)) : n > r && (i = (0, it.Y)(t.min, t.max - r, e.min)), (0, ea.u)(0, 1, i);
                ...
                addListeners() {
                    ...
                    let r = tv(window, "resize", () => this.scalePositionWithinConstraints()),
            ...
            class i$ extends tC {
                constructor(t) {
                    super(t), (this.removeGroupControls = tR.Z), (this.removeListeners = tR.Z), (this.controls = new iO(t));
                }
                mount() {
            ...
            class iI extends tC {
                ...
                onPointerDown(t) {
                    this.session = new e8(t, this.createPanHandlers(), { transformPagePoint: this.node.getTransformPagePoint(), contextWindow: iF(this.node) });
                }
                createPanHandlers() {
            ...
            function iY(t) {
                ...
                return o.createElement(iZ, { ...t, layoutGroup: n, switchLayoutGroup: (0, o.useContext)(V), isPresent: e, safeToRemove: i });
            }
            let iX = {
                borderRadius: { ...iz, applyTo: ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomLeftRadius", "borderBottomRightRadius"] },
            ...
            var iq = i(1762);
            let iG = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
                iK = iG.length,
                i_ = (t) => ("string" == typeof t ? parseFloat(t) : t),
                iJ = (t) => "number" == typeof t || U.px.test(t);
            function iQ(t, e) {
            ...
            function i6(t, e, [i, n, r], s, o) {
                !(function (t, e = 0, i = 1, n = 0.5, r, s = t, o = t) {
                    if ((U.aQ.test(e) && ((e = parseFloat(e)), (e = (0, ie.C)(o.min, o.max, e / 100) - o.min)), "number" != typeof e)) return;
                    let a = (0, ie.C)(s.min, s.max, n);
                    t === s && (a -= e), (t.min = i8(t.min, e, i, a, r)), (t.max = i8(t.max, e, i, a, r));
                })(t, e[i], e[n], e[r], e.scale, s, o);
            }
            let i9 = ["x", "scaleX", "originX"],
                i4 = ["y", "scaleY", "originY"];
            function i7(t, e, i, n) {
                i6(t.x, e, i9, i ? i.x : void 0, n ? n.x : void 0), i6(t.y, e, i4, i ? i.y : void 0, n ? n.y : void 0);
            }
            function nt(t) {
            ...
            class ns {
                ...
                add(t) {
                    (0, nr.y4)(this.members, t), t.scheduleRender();
                }
                remove(t) {
                    if (((0, nr.cl)(this.members, t), t === this.prevLead && (this.prevLead = void 0), t === this.lead)) {
            ...
            let na = (t, e) => t.depth - e.depth;
            class nl {
                constructor() {
                    (this.children = []), (this.isDirty = !1);
                }
                add(t) {
                    (0, nr.y4)(this.children, t), (this.isDirty = !0);
                }
                remove(t) {
                    (0, nr.cl)(this.children, t), (this.isDirty = !0);
                }
                forEach(t) {
            ...
            let nu = ["", "X", "Y", "Z"],
                ...
                nc = 0,
                nd = { type: "projectionFrame", totalNodes: 0, resolvedTargetDeltas: 0, recalculatedProjection: 0 };
            function np({ attachResizeListener: t, defaultParent: e, measureScroll: i, checkIsScrollRoot: n, resetTransform: r }) {
                return class {
                    constructor(t = {}, i = null == e ? void 0 : e()) {
                        (this.id = nc++),
                            ...
                            (this.updateProjection = () => {
                                (this.projectionUpdateScheduled = !1),
                                    (nd.totalNodes = nd.resolvedTargetDeltas = nd.recalculatedProjection = 0),
                    ...
                    addEventListener(t, e) {
                        return this.eventHandlers.has(t) || this.eventHandlers.set(t, new iq.L()), this.eventHandlers.get(t).add(e);
                    }
                    notifyListeners(t, ...e) {
                                ...
                                (this.root.updateBlockedByResize = !0),
                                    ...
                                    (i = (function (t, e) {
                                        let i = performance.now(),
                                            n = ({ timestamp: e }) => {
                                                let r = e - i;
                                                r >= 250 && ((0, tp.Pn)(n), t(r - 250));
                                            };
                                        return tp.Wi.read(n, !0), () => (0, tp.Pn)(n);
                                    })(n, 0)),
                                    iN.hasAnimatedSinceResize && ((iN.hasAnimatedSinceResize = !1), this.nodes.forEach(nw));
                            });
                        }
                        n && this.root.registerSharedNode(n, this),
                            !1 !== this.options.animate &&
                                ...
                                this.addEventListener("didUpdate", ({ delta: t, hasLayoutChanged: e, hasRelativeTargetChanged: i, layout: n }) => {
                                    ...
                                    let r = this.options.transition || s.getDefaultTransition() || nM,
                                    ...
                                    if (this.options.layoutRoot || (this.resumeFrom && this.resumeFrom.instance) || u || (e && (l || !this.currentAnimation))) {
                                        ...
                                        let e = { ...eW(r, "layout"), onPlay: o, onComplete: a };
                                        (s.shouldReduceMotion || this.options.layoutRoot) && ((e.delay = 0), (e.type = !1)), this.startAnimation(e);
                                    } else e || nw(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
                                    this.targetLayout = n;
                                });
                    }
                    unmount() {
                    ...
                    update() {
                        ...
                        this.isUpdating || this.nodes.forEach(nP), (this.isUpdating = !1), this.nodes.forEach(nb), this.nodes.forEach(nm), this.nodes.forEach(nf), this.clearAllSnapshots();
                        let t = performance.now();
                        (tp.frameData.delta = (0, ea.u)(0, 1e3 / 60, t - tp.frameData.timestamp)),
                            (tp.frameData.timestamp = t),
                            (tp.frameData.isProcessing = !0),
                            tp.S6.update.process(tp.frameData),
                            tp.S6.preRender.process(tp.frameData),
                            tp.S6.render.process(tp.frameData),
                            (tp.frameData.isProcessing = !1);
                    }
                    didUpdate() {
                        this.updateScheduled || ((this.updateScheduled = !0), queueMicrotask(() => this.update()));
                    }
                    clearAllSnapshots() {
                        this.nodes.forEach(ny), this.sharedNodes.forEach(nV);
                    }
                    scheduleUpdateProjection() {
                        this.projectionUpdateScheduled || ((this.projectionUpdateScheduled = !0), tp.Wi.preRender(this.updateProjection, !1, !0));
                    }
                    ...
                    resetTransform() {
                        ...
                        let t = this.isLayoutDirty || this.shouldResetTransform,
                            e = this.projectionDelta && !ne(this.projectionDelta),
                            i = this.getTransformTemplate(),
                            n = i ? i(this.latestValues, "") : void 0,
                            s = n !== this.prevTransformTemplateValue;
                        t && (e || iA(this.latestValues) || s) && (r(this.instance, n), (this.shouldResetTransform = !1), this.scheduleRender());
                    }
                    measure(t = !0) {
                        var e;
                        let i = this.measurePageBox(),
                            n = this.removeElementScroll(i);
                        return t && (n = this.removeTransform(n)), nL((e = n).x), nL(e.y), { animationId: this.root.animationId, measuredBox: i, layoutBox: n, latestValues: {}, source: this.id };
                    }
                    measurePageBox() {
                        let { visualElement: t } = this.options;
                        if (!t) return iy();
                    ...
                    applyTransform(t, e = !1) {
                        ...
                        for (let t = 0; t < this.path.length; t++) {
                            let n = this.path[t];
                            !e && n.options.layoutScroll && n.scroll && n !== n.root && iL(i, { x: -n.scroll.offset.x, y: -n.scroll.offset.y }), iA(n.latestValues) && iL(i, n.latestValues);
                        }
                        return iA(this.latestValues) && iL(i, this.latestValues), i;
                    }
                    removeTransform(t) {
                        let e = iy();
                        i3(e, t);
                        for (let t = 0; t < this.path.length; t++) {
                            let i = this.path[t];
                            if (!i.instance || !iA(i.latestValues)) continue;
                            iw(i.latestValues) && i.updateSnapshot();
                            let n = iy();
                            i3(n, i.measurePageBox()), i7(e, i.latestValues, i.snapshot ? i.snapshot.layoutBox : void 0, n);
                        }
                        return iA(this.latestValues) && i7(e, this.latestValues), e;
                    }
                    setTargetDelta(t) {
                            ...
                            if (((this.resolvedRelativeTargetAt = tp.frameData.timestamp), !this.targetDelta && !this.relativeTarget)) {
                                ...
                                t && t.layout && 1 !== this.animationProgress
                                    ? ((this.relativeParent = t),
                                      ...
                                      iu(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox),
                                      i3(this.relativeTarget, this.relativeTargetOrigin))
                                    : (this.relativeParent = this.relativeTarget = void 0);
                            }
                            if (this.relativeTarget || this.targetDelta) {
                                if (
                                    ((this.target || ((this.target = iy()), (this.targetWithTransforms = iy())), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target)
                                        ? (this.forceRelativeParentToResolveTarget(), (i = this.target), (n = this.relativeTarget), (r = this.relativeParent.target), ia(i.x, n.x, r.x), ia(i.y, n.y, r.y))
                                        : this.targetDelta
                                        ? (this.resumingFrom ? (this.target = this.applyTransform(this.layout.layoutBox)) : i3(this.target, this.layout.layoutBox), iC(this.target, this.targetDelta))
                    ...
                    getClosestProjectingParent() {
                        return !this.parent || iw(this.parent.latestValues) || iT(this.parent.latestValues) ? void 0 : this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent();
                    }
                    isProjecting() {
                    ...
                    calcProjection() {
                        ...
                        if (
                            ...
                            this.resolvedRelativeTargetAt === tp.frameData.timestamp && (n = !1),
                            n)
                        )
                            return;
                            ...
                            if (o) {
                                ...
                                for (let a = 0; a < o; a++) {
                                    ...
                                    (!o || !o.style || "contents" !== o.style.display) &&
                                        (n && r.options.layoutScroll && r.scroll && r !== r.root && iL(t, { x: -r.scroll.offset.x, y: -r.scroll.offset.y }),
                                        s && ((e.x *= s.x.scale), (e.y *= s.y.scale), iC(t, s)),
                                        n && iA(r.latestValues) && iL(t, r.latestValues));
                                }
                        ...
                        let { target: l } = e;
                        if (!l) {
                            this.projectionTransform && ((this.projectionDelta = iv()), (this.projectionTransform = "none"), this.scheduleRender());
                            return;
                        }
                        this.projectionDelta || ((this.projectionDelta = iv()), (this.projectionDeltaWithTransform = iv()));
                        let u = this.projectionTransform;
                        io(this.projectionDelta, this.layoutCorrected, l, this.latestValues),
                            (this.projectionTransform = no(this.projectionDelta, this.treeScale)),
                            (this.projectionTransform !== u || this.treeScale.x !== o || this.treeScale.y !== a) && ((this.hasProjected = !0), this.scheduleRender(), this.notifyListeners("projectionUpdate", l)),
                    ...
                    setAnimationOrigin(t, e = !1) {
                        ...
                        let a = iy(),
                            ...
                            c = !!(l && !h && !0 === this.options.crossfade && !this.path.some(nD));
                        (this.animationProgress = 0),
                            (this.mixTargetDelta = (e) => {
                                let n = e / 1e3;
                                if ((nC(o.x, t.x, n), nC(o.y, t.y, n), this.setTargetDelta(o), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout)) {
                                    var u, d, p, m;
                                    iu(a, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
                                        (p = this.relativeTarget),
                                        (m = this.relativeTargetOrigin),
                                        nE(p.x, m.x, a.x, n),
                                        nE(p.y, m.y, a.y, n),
                                        i && ((u = this.relativeTarget), (d = i), u.x.min === d.x.min && u.x.max === d.x.max && u.y.min === d.y.min && u.y.max === d.y.max) && (this.isProjectionDirty = !1),
                                        i || (i = iy()),
                                ...
                                l &&
                                    ...
                                    (function (t, e, i, n, r, s) {
                                        r
                                            ? ((t.opacity = (0, ie.C)(0, void 0 !== i.opacity ? i.opacity : 1, i0(n))), (t.opacityExit = (0, ie.C)(void 0 !== e.opacity ? e.opacity : 1, 0, i1(n))))
                                            : s && (t.opacity = (0, ie.C)(void 0 !== e.opacity ? e.opacity : 1, void 0 !== i.opacity ? i.opacity : 1, n));
                                        for (let r = 0; r < iK; r++) {
                                            let s = `border${iG[r]}Radius`,
                                                o = iQ(e, s),
                                                a = iQ(i, s);
                                            (void 0 !== o || void 0 !== a) &&
                                                (o || (o = 0), a || (a = 0), 0 === o || 0 === a || iJ(o) === iJ(a) ? ((t[s] = Math.max((0, ie.C)(i_(o), i_(a), n), 0)), (U.aQ.test(a) || U.aQ.test(o)) && (t[s] += "%")) : (t[s] = a));
                                        }
                                        (e.rotate || i.rotate) && (t.rotate = (0, ie.C)(e.rotate || 0, i.rotate || 0, n));
                    ...
                    startAnimation(t) {
                        this.notifyListeners("animationStart"),
                            ...
                            this.pendingAnimation && ((0, tp.Pn)(this.pendingAnimation), (this.pendingAnimation = void 0)),
                            (this.pendingAnimation = tp.Wi.update(() => {
                                (iN.hasAnimatedSinceResize = !0),
                                    (this.currentAnimation = (function (t, e, i) {
                                        let n = j(0) ? 0 : (0, eH.BX)(0);
                                        return n.start(eU("", n, 1e3, i)), n.animation;
                                    })(0, 0, {
                                        ...t,
                                        onUpdate: (e) => {
                    ...
                    applyTransformsToTarget() {
                        ...
                        if (e && i && n) {
                            if (this !== t && this.layout && n && nj(this.options.animationType, this.layout.layoutBox, n.layoutBox)) {
                                i = this.target || iy();
                            ...
                            i3(e, i), iL(e, r), io(this.projectionDeltaWithTransform, this.layoutCorrected, e, r);
                        }
                    }
                    registerSharedNode(t, e) {
                        this.sharedNodes.has(t) || this.sharedNodes.set(t, new ns()), this.sharedNodes.get(t).add(e);
                    ...
                    getProjectionStyles(t) {
                        ...
                        if (this.needsReset) return (this.needsReset = !1), (n.opacity = ""), (n.pointerEvents = tc(null == t ? void 0 : t.pointerEvents) || ""), (n.transform = r ? r(this.latestValues, "") : "none"), n;
                        let s = this.getLead();
                        if (!this.projectionDelta || !this.layout || !s.target) {
                            let e = {};
                            return (
                                this.options.layoutId && ((e.opacity = void 0 !== this.latestValues.opacity ? this.latestValues.opacity : 1), (e.pointerEvents = tc(null == t ? void 0 : t.pointerEvents) || "")),
                                this.hasProjected && !iA(this.latestValues) && ((e.transform = r ? r({}, "") : "none"), (this.hasProjected = !1)),
                                e
                            );
                        }
                        let o = s.animationValues || s.latestValues;
                        this.applyTransformsToTarget(), (n.transform = no(this.projectionDeltaWithTransform, this.treeScale, o)), r && (n.transform = r(o, n.transform));
                        ...
                        return this.options.layoutId && (n.pointerEvents = s === this ? tc(null == t ? void 0 : t.pointerEvents) || "" : "none"), n;
                    }
                    clearSnapshot() {
            ...
            function nf(t) {
                ...
                if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
                    ...
                    io(o, e, i.layoutBox);
                    let a = iv();
                    s ? io(a, t.applyTransform(n, !0), i.measuredBox) : io(a, e, i.layoutBox);
                    let l = !ne(o),
                        u = !1;
                    if (!t.resumeFrom) {
                        ...
                        if (n && !n.resumeFrom) {
                            ...
                            if (r && s) {
                                ...
                                let a = iy();
                                iu(a, e, s.layoutBox), ni(o, a) || (u = !0), n.options.layoutRoot && ((t.relativeTarget = a), (t.relativeTargetOrigin = o), (t.relativeParent = n));
                            }
                        }
                    }
            ...
            function nC(t, e, i) {
                (t.translate = (0, ie.C)(e.translate, 0, i)), (t.scale = (0, ie.C)(e.scale, 1, i)), (t.origin = e.origin), (t.originPoint = e.originPoint);
            }
            function nE(t, e, i, n) {
                (t.min = (0, ie.C)(e.min, i.min, n)), (t.max = (0, ie.C)(e.max, i.max, n));
            }
            function nD(t) {
                return t.animationValues && void 0 !== t.animationValues.opacityExit;
            }
            let nM = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
                nk = (t) => "undefined" != typeof navigator && navigator.userAgent.toLowerCase().includes(t),
                nR = nk("applewebkit/") && !nk("chrome/") ? Math.round : tR.Z;
            function nL(t) {
                (t.min = nR(t.min)), (t.max = nR(t.max));
            }
            function nj(t, e, i) {
                return "position" === t || ("preserve-aspect" === t && !ir(nn(e), nn(i), 0.2));
            }
            let nF = np({
                ...
                nW = /var\((--[a-zA-Z0-9-_]+),? ?([a-zA-Z0-9 ()%#.,-]+)?\)/;
            function n$(t, e, i = 1) {
                (0, tH.k)(i <= 4, `Max CSS variable fallback depth detected in property "${t}". This may indicate a circular fallback dependency.`);
                let [n, r] = (function (t) {
                    let e = nW.exec(t);
                    if (!e) return [,];
                    let [, i, n] = e;
                ...
                return (0, O.tm)(r) ? n$(r, e, i + 1) : r;
            }
            let nU = new Set(["width", "height", "top", "left", "right", "bottom", "x", "y", "translateX", "translateY"]),
                nI = (t) => nU.has(t),
                nN = (t) => Object.keys(t).some(nI),
                nH = (t) => t === $.Rx || t === U.px,
                nz = (t, e) => parseFloat(t.split(", ")[e]),
                nZ = (t, e) => (i, { transform: n }) => {
                    if ("none" === n || !n) return 0;
                    let r = n.match(/^matrix3d\((.+)\)$/);
                    if (r) return nz(r[1], e);
                    {
            ...
            (nq.translateX = nq.x), (nq.translateY = nq.y);
            let nG = (t, e, i) => {
                        ...
                        (r.forEach((r) => {
                            ...
                            if (tl(d)) {
                                ...
                                for (let i = e; i < t && null !== d[i]; i++)
                                    l ? (0, tH.k)(eY(d[i]) === l, "All keyframes must be of the same type") : ((l = eY(d[i])), (0, tH.k)(l === c || (nH(c) && nH(l)), "Keyframes must be of the same dimension as the current value"));
                            } else l = eY(d);
                            if (c !== l) {
                                if (nH(c) && nH(l)) {
                                    let t = u.get();
                                    "string" == typeof t && u.set(parseFloat(t)), "string" == typeof d ? (e[r] = parseFloat(d)) : Array.isArray(d) && l === U.px && (e[r] = d.map(parseFloat));
                                } else
                ...
                n_ = (t, e, i, n) => {
                    ...
                    return (e = o.target), (n = o.transitionEnd), (r = e), (s = n), nN(r) ? nK(t, r, i, s) : { target: r, transitionEnd: s };
                },
                nJ = { current: null },
                nQ = { current: !1 },
                n0 = new WeakMap(),
            ...
            class n8 {
                constructor({ parent: t, props: e, presenceContext: i, reducedMotionConfig: n, visualState: r }, s = {}) {
                    ...
                    for (let t in u) {
                        let e = u[t];
                        void 0 !== o[t] && j(e) && (e.set(o[t], !1), eI(l) && l.add(t));
                    }
                }
                                ...
                                if (((nQ.current = !0), T.j)) {
                                    if (window.matchMedia) {
                                        let t = window.matchMedia("(prefers-reduced-motion)"),
                                            e = () => (nJ.current = t.matches);
                                        t.addListener(e), e();
                                    } else nJ.current = !1;
                                }
                            })(),
                        (this.shouldReduceMotion = "never" !== this.reducedMotionConfig && ("always" === this.reducedMotionConfig || nJ.current)),
                        this.parent && this.parent.children.add(this),
                        this.update(this.props, this.presenceContext);
                }
                unmount() {
                    for (let t in (n0.delete(this.current),
                    this.projection && this.projection.unmount(),
                    (0, tp.Pn)(this.notifyUpdate),
                    (0, tp.Pn)(this.render),
                ...
                bindToMotionValue(t, e) {
                    let i = R.has(t),
                        n = e.on("change", (e) => {
                            (this.latestValues[t] = e), this.props.onUpdate && tp.Wi.update(this.notifyUpdate, !1, !0), i && this.projection && (this.projection.isTransformDirty = !0);
                        }),
                ...
                loadFeatures({ children: t, ...e }, i, n, r) {
                    ...
                    for (let t = 0; t < n5; t++) {
                        let i = n1[t],
                            { isEnabled: n, Feature: r, ProjectionNode: a, MeasureLayout: l } = A[i];
                ...
                update(t, e) {
                    ...
                    (this.prevMotionValues = (function (t, e, i) {
                        ...
                        for (let r in e) {
                            let s = e[r],
                                o = i[r];
                            if (j(s)) t.addValue(r, s), eI(n) && n.add(r);
                            else if (j(o)) t.addValue(r, (0, eH.BX)(s, { owner: t })), eI(n) && n.remove(r);
                            else if (o !== s) {
                                if (t.hasValue(r)) {
                                    let e = t.getValue(r);
                                    ...
                                    t.addValue(r, (0, eH.BX)(void 0 !== e ? e : s, { owner: t }));
                                }
                            }
                        }
                ...
                getValue(t, e) {
                    ...
                    return void 0 === i && void 0 !== e && ((i = (0, eH.BX)(e, { owner: this })), this.addValue(t, i)), i;
                }
                readValue(t) {
                    var e;
                ...
                getBaseTarget(t) {
                    ...
                    let { initial: i } = this.props,
                        n = "string" == typeof i || "object" == typeof i ? (null === (e = to(this.props, i)) || void 0 === e ? void 0 : e[t]) : void 0;
                    if (i && void 0 !== n) return n;
                    let r = this.getBaseTargetFromProps(this.props, t);
                    return void 0 === r || j(r) ? (void 0 !== this.initialValues[t] && void 0 === n ? void 0 : this.baseTarget[t]) : r;
                }
                on(t, e) {
                    return this.events[t] || (this.events[t] = new iq.L()), this.events[t].add(e);
                }
                notify(t, ...e) {
                            ...
                            if (o)
                                for (let a = 0; a < o; a++) {
                                    ...
                                    Array.isArray(l) && (u = l[0]),
                                        ...
                                        null != u &&
                                            ("string" == typeof u && (eN(u) || eO(u)) ? (u = parseFloat(u)) : !eq(u) && eV.P.test(l) && (u = eB(o, l)),
                                            t.addValue(o, (0, eH.BX)(u, { owner: t })),
                                            void 0 === i[o] && (i[o] = u),
                ...
                readValueFromInstance(t, e) {
                    ...
                    }
                    {
                        let i = window.getComputedStyle(t),
                            n = ((0, O.f9)(e) ? i.getPropertyValue(e) : i[e]) || 0;
            ...
            class n4 extends n6 {
                ...
                readValueFromInstance(t, e) {
                    ...
                    return (e = ti.has(e) ? e : d(e)), t.getAttribute(e);
                }
                ...
                build(t, e, i, n) {
                    J(t, e, i, this.isSVGTag, n.transformTemplate);
                }
                renderInstance(t, e, i, n) {
                    tn(t, e, i, n);
                }
            ...
            let n7 = (t, e) => (D(t) ? new n4(e, { enableHardwareAcceleration: !1 }) : new n9(e, { enableHardwareAcceleration: !0 })),
                rt = {
                    ...
                    hover: { Feature: tD },
                    pan: { Feature: iI },
                    drag: { Feature: i$, ProjectionNode: nO, MeasureLayout: iY },
                    layout: { ProjectionNode: nO, MeasureLayout: iY },
                },
                re = (function (t) {
                    function e(e, i = {}) {
                                    ...
                                    w = (function (t) {
                                        let { initial: e, animate: i } = (function (t, e) {
                                            if (x(t)) {
                                                ...
                                                return { initial: !1 === e || f(e) ? e : void 0, animate: f(i) ? i : void 0 };
                                            }
                                            return !1 !== t.inherit ? e : {};
                                        })(t, (0, o.useContext)(l));
                                        return (0, o.useMemo)(() => ({ initial: e, animate: i }), [b(e), b(i)]);
                                    })(s),
                                    A = n(s, P);
                                if (!P && T.j) {
                                    w.visualElement = (function (t, e, i, n) {
                                        let { visualElement: r } = (0, o.useContext)(l),
                                            ...
                                            f = (0, o.useRef)();
                                        (n = n || s.renderer), !f.current && n && (f.current = n(t, { visualState: e, parent: r, props: i, presenceContext: d, blockInitialAnimation: !!d && !1 === d.initial, reducedMotionConfig: m }));
                                        let v = f.current;
                                        (0, o.useInsertionEffect)(() => {
                                            v && v.update(i, d);
                                        });
                                        let g = (0, o.useRef)(!!(i[p] && !window.HandoffComplete));
                                        return (
                                            (0, h.L)(() => {
                                    ...
                                    w.visualElement && (g = w.visualElement.loadFeatures(y, n, t, i));
                                }
                                return o.createElement(
                                    l.Provider,
                                    { value: w },
                                    g && w.visualElement ? o.createElement(g, { visualElement: w.visualElement, ...y }) : null,
                                    i(
                                        r,
                                        s,
                                        ((v = w.visualElement),
                                        (0, o.useCallback)(
                                            (t) => {
                                                t && A.mount && A.mount(t), v && (t ? v.mount(t) : v.unmount()), d && ("function" == typeof d ? d(t) : m(d) && (d.current = t));
                                            },
                                            [v]
                                        )),
                                        A,
                                ...
                                return (e, i, n, { latestValues: r }, s) => {
                                    let a = (D(e)
                                            ? function (t, e, i, n) {
                                                  let r = (0, o.useMemo)(() => {
                                                      let i = Q();
                                                      return J(i, e, { enableHardwareAcceleration: !1 }, tt(n), t.transformTemplate), { ...i.attrs, style: { ...i.style } };
                                                  }, [e]);
                                                  if (t.style) {
                                                      let e = {};
                                                      Z(e, t.style, t), (r.style = { ...e, ...r.style });
                                                  }
                                                  return r;
                                              }
                                            : function (t, e, i) {
                                                          ...
                                                          return (
                                                              ...
                                                              Object.assign(
                                                                  ...
                                                                  (function ({ transformTemplate: t }, e, i) {
                                                                      return (0, o.useMemo)(() => {
                                                                          let n = z();
                                                                          return H(n, e, { enableHardwareAcceleration: !i }, t), Object.assign({}, n.vars, n.style);
                                                                      }, [e]);
                                                                  })(t, e, i)
                                                              ),
                                                  ...
                                                  return (
                                                      t.drag &&
                                                          !1 !== t.dragListener &&
                                                          ((n.draggable = !1), (r.userSelect = r.WebkitUserSelect = r.WebkitTouchCallout = "none"), (r.touchAction = !0 === t.drag ? "none" : `pan-${"x" === t.drag ? "y" : "x"}`)),
        ...
        6292: function (t, e, i) {
                        ...
                        (i = (function ({ hue: t, saturation: e, lightness: i, alpha: n }) {
                            ...
                            if ((e /= 100)) {
                                let n = i < 0.5 ? i * (1 + e) : i + e - i * e,
                                    l = 2 * i - n;
                                (r = a(l, n, t + 1 / 3)), (s = a(l, n, t)), (o = a(l, n, t - 1 / 3));
                            } else r = s = o = i;
            ...
            let y = (t, e) => (i) => `${i > 0 ? e : t}`;
            function x(t, e) {
                return "number" == typeof t ? (i) => (0, o.C)(t, e, i) : r.$.test(t) ? f(t, e) : t.startsWith("var(") ? y(t, e) : w(t, e);
            }
            let P = (t, e) => {
                    let i = [...t],
                        n = i.length,
        ...
        8918: function (t, e, i) {
            ...
            var n = i(7653);
            let r = i(9701).j ? n.useLayoutEffect : n.useEffect;
        },
        5311: function (t, e, i) {
            i.d(e, {
                R: function () {
                ...
                constructor(t, e = {}) {
                    (this.version = "10.18.0"),
                        ...
                        (this.updateAndNotify = (t, e = !0) => {
                            ...
                            this.lastUpdated !== n && ((this.timeDelta = i), (this.lastUpdated = n), s.Wi.postRender(this.scheduleVelocityCheck)),
        ...
        5726: function (t, e, i) {
            ...
            let a = {
                ...
                transform: ({ hue: t, saturation: e, lightness: i, alpha: o = 1 }) => "hsla(" + Math.round(t) + ", " + r.aQ.transform((0, s.Nw)(e)) + ", " + r.aQ.transform((0, s.Nw)(i)) + ", " + (0, s.Nw)(n.Fq.transform(o)) + ")",
            };
        },
        8306: function (t, e, i) {
            i.d(e, {
        ...
        1962: function (t, e, i) {
            ...
            let a = (t) => (0, n.u)(0, 255, t),
                ...
                u = {
                    ...
                    transform: ({ red: t, green: e, blue: i, alpha: n = 1 }) => "rgba(" + l.transform(t) + ", " + l.transform(e) + ", " + l.transform(i) + ", " + (0, s.Nw)(r.Fq.transform(n)) + ")",
                };
        },
        8084: function (t, e, i) {
            i.d(e, {
            ...
            let r = (t, e) => (i) => !!(((0, n.HD)(i) && n.mj.test(i) && i.startsWith(t)) || (e && Object.prototype.hasOwnProperty.call(i, e))),
                s = (t, e, i) => (r) => {
                    ...
                    return { [t]: parseFloat(s), [e]: parseFloat(o), [i]: parseFloat(a), alpha: void 0 !== l ? parseFloat(l) : 1 };
                };
        },
        6728: function (t, e, i) {
            i.d(e, {
            ...
            let l = { regex: n.Xp, countKey: "Vars", token: "${v}", parse: r.Z },
                u = { regex: a.dA, countKey: "Colors", token: "${c}", parse: s.$.parse },
                h = { regex: a.KP, countKey: "Numbers", token: "${n}", parse: o.Rx.parse };
        ...
        6183: function (t, e, i) {
            ...
            var n = i(8884);
            let r = (t) => ({ test: (e) => (0, n.HD)(e) && e.endsWith(t) && 1 === e.split(" ").length, parse: parseFloat, transform: (e) => `${e}${t}` }),
                s = r("deg"),
                o = r("%"),
                a = r("px"),
                l = r("vh"),
